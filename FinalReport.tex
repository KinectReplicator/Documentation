...
\begin{figure}[H]
\centering
\includegraphics[width=70mm]{image (1).jpeg}
\caption{The Xbox Kinect, the center camera is the RGB camera and the two outer cameras are the 3D sensors. The base has a motorized tilt and a multi-array mic goes along the bottom of the wand.}
\label{kinectlable}
\end{figure}
